...
| [BUG_history_card_sparkline_misplaced](BUG_history_card_sparkline_misplaced.md) | History exercise card — sparkline trend line not inline with Best Set / Est 1RM stats | ✅ Completed | P2 | History card set details ✅ | — | `WorkoutSummaryScreen.kt` |
| [BUG_deep_link_nav_tab_broken](BUG_deep_link_nav_tab_broken.md) | Bottom nav broken after History → Trends deep-link — History tab does nothing, then misdirects to Trends | ✅ Completed | P1 | History → Trends deep-link ✅ | — | `PowerMeNavigation.kt` |
| [BUG_history_delete_nav_back](BUG_history_delete_nav_back.md) | Delete workout from History navigates back to deleted workout summary instead of History list | ✅ Completed | P1 | — | — | `WorkoutDetailScreen.kt`, `PowerMeNavigation.kt`, `WorkoutDetailViewModelTest.kt` |
| [BUG_muscle_balance_groups_by_day](BUG_muscle_balance_groups_by_day.md) | Muscle Balance + Effective Sets cards group volume by day instead of by week | ✅ Completed | P1 | BUG_muscle_group_table_not_seeded ✅ | — | `TrendsDao.kt`, `TrendsRepositoryWeeklyGroupingTest.kt` |
| [BUG_effective_sets_filter_ignored](BUG_effective_sets_filter_ignored.md) | Effective Sets card — time range filter chips have no effect, same data shown for all ranges | ✅ Completed | P1 | BUG_muscle_group_table_not_seeded ✅ | — | `TrendsDao.kt`, `TrendsViewModelEffectiveSetsFilterTest.kt` |
...
| [BUG_hc_extended_reads_no_data](BUG_hc_extended_reads_no_data.md) | All HC data missing — full Health Connect sync broken (weight, body fat, HR, VO₂, SpO₂, Calories) | 🔵 Open | P0 | — | — | — |
