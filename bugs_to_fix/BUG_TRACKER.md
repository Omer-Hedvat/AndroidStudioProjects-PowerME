...
| [BUG_hc_extended_reads_no_data](BUG_hc_extended_reads_no_data.md) | All HC data missing — full Health Connect sync broken (weight, body fat, HR, VO₂, SpO₂, Calories) | 🟡 In Progress | P0 | — | — | — |
