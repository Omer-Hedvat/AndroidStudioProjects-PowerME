...
| [BUG_effective_sets_filter_ignored](BUG_effective_sets_filter_ignored.md) | Effective Sets card — time range filter chips have no effect, same data shown for all ranges | 🔵 Open | P1 | BUG_muscle_group_table_not_seeded ✅ | — | `TrendsDao.kt`, `TrendsViewModelEffectiveSetsFilterTest.kt` |
