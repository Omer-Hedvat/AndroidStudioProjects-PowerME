...
| [BUG_func_overlay_mid_round_alert](BUG_func_overlay_mid_round_alert.md) | Functional overlays missing mid-round alert (haptic/sound) | ✅ Completed | P2 | — | — | `TimerEngine.kt`, `FunctionalBlockRunner.kt`, `TimerSpec.kt` |
...
| [BUG_func_emom_skip_round_broken](BUG_func_emom_skip_round_broken.md) | EMOM "Skip Round" button does not advance to next round or update round counter | ✅ Completed | P1 | — | — | `TimerEngine.kt`, `FunctionalBlockRunner.kt`, `WorkoutViewModel.kt`, `ActiveWorkoutScreen.kt` |
