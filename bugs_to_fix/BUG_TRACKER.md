...
| [BUG_func_active_block_organize_edit](BUG_func_active_block_organize_edit.md) | Functional block cards have no edit/delete; organize mode ignores block structure and allows invalid supersets | 🟡 In Progress | P1 | func_active_block_card_ui ✅ | FUNC_TEMPLATE_BUILDER_POLISH_SPEC | — |
