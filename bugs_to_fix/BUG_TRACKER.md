...
| [BUG_chronotype_card_missing_title](BUG_chronotype_card_missing_title.md) | Chronotype card missing top-level card title | 🔵 Open | P3 | — | — | — |
...
| [BUG_deleted_rest_timer_returns](BUG_deleted_rest_timer_returns.md) | Deleted rest timers reappear after app reopen or workout restart | 🔵 Open | P1 | — | — | `WorkoutViewModel.kt`, `WorkoutsScreen.kt`, `WorkoutDao.kt`, `FirestoreSyncManager.kt` |
...
| [BUG_rest_timer_end_beep_missing](BUG_rest_timer_end_beep_missing.md) | Long beep at end of rest timer is missing | 🔵 Open | P2 | — | — | `RestTimerNotifier.kt`, `WorkoutViewModel.kt` |
