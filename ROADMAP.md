...
|---|---|---|---|---|---|
| Functional Training | `FUNCTIONAL_TRAINING_SPEC.md` | P8 | `in-progress` | 9/20 wrapped · 4 completed · 2 in-progress · 3 not-started | 20 |
...
| Alternative exercise — movement-specific weight transfer | `future_devs/ALTERNATIVE_WEIGHT_TRANSFER_SPEC.md` | M | `completed` | Exercise Detail Tabs v2 ✅ |
...
| Feature | Spec | Effort | Status | Depends on |
|---|---|---|---|---|
| Embed block arrays in Firestore push/pull | `future_devs/FUNC_FIRESTORE_SYNC_BLOCKS_SPEC.md` | M | `completed` | Block entities migration ✅ |
| FunctionalBlockWizard + Pure Functional template builder | `future_devs/FUNC_TEMPLATE_WIZARD_SPEC.md` | L | `in-progress` | Block entities migration ✅ |
...
| Block headers in active workout; STRENGTH materialisation on start | `future_devs/FUNC_ACTIVE_STRENGTH_BLOCKS_SPEC.md` | M | `in-progress` | Block entities migration ✅ |
